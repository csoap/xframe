...
public class HotUpdater
{
    ...
    public void Start()
    {
        ...
        if (null != updateInfos)
        {
            ...
            // 需要整包更新
            Debug.Log(m_needFullAppUpdate + "_" + m_hasNextUpdateBtn + "_"+ m_sameAppVerResUpdate);
    ...
    public void CalculateUpdatePackList(List<UpdateInfo> updateInfos)
    {
        ...
        GameLogger.Log("updateInfos:" + updateInfos);
    ...
    private void StartDownloadResPack(bool next = false)
    {
        ...
        if (next)
            ++m_curPackIndex;
            GameLogger.Log("m_curPackIndex: " + m_curPackIndex);
    ...
    private bool CheckMd5(string filePath, string md5)
    {
        ...
        var ok = localMd5.Equals(md5.ToLower());
