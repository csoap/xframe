...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(UnityEngine.Events.UnityAction<object>), factory.UnityEngine_Events_UnityAction_object);
		...
		dict.Add(typeof(System.Predicate<byte[]>), factory.System_Predicate_bytes);
		dict.Add(typeof(System.Action<byte[]>), factory.System_Action_bytes);
		dict.Add(typeof(System.Comparison<byte[]>), factory.System_Comparison_bytes);
		...
		dict.Add(typeof(System.Action<string,SpObject>), factory.System_Action_string_SpObject);
		dict.Add(typeof(MyEventHandler), factory.MyEventHandler);
		...
		DelegateTraits<UnityEngine.Events.UnityAction<object>>.Init(factory.UnityEngine_Events_UnityAction_object);
		...
		DelegateTraits<System.Predicate<byte[]>>.Init(factory.System_Predicate_bytes);
		DelegateTraits<System.Action<byte[]>>.Init(factory.System_Action_bytes);
		DelegateTraits<System.Comparison<byte[]>>.Init(factory.System_Comparison_bytes);
		...
		DelegateTraits<System.Action<string,SpObject>>.Init(factory.System_Action_string_SpObject);
		DelegateTraits<MyEventHandler>.Init(factory.MyEventHandler);
		...
		TypeTraits<UnityEngine.Events.UnityAction<object>>.Init(factory.Check_UnityEngine_Events_UnityAction_object);
		...
		TypeTraits<System.Predicate<byte[]>>.Init(factory.Check_System_Predicate_bytes);
		TypeTraits<System.Action<byte[]>>.Init(factory.Check_System_Action_bytes);
		TypeTraits<System.Comparison<byte[]>>.Init(factory.Check_System_Comparison_bytes);
		...
		TypeTraits<System.Action<string,SpObject>>.Init(factory.Check_System_Action_string_SpObject);
		TypeTraits<MyEventHandler>.Init(factory.Check_MyEventHandler);
		...
		StackTraits<UnityEngine.Events.UnityAction<object>>.Push = factory.Push_UnityEngine_Events_UnityAction_object;
		...
		StackTraits<System.Predicate<byte[]>>.Push = factory.Push_System_Predicate_bytes;
		StackTraits<System.Action<byte[]>>.Push = factory.Push_System_Action_bytes;
		StackTraits<System.Comparison<byte[]>>.Push = factory.Push_System_Comparison_bytes;
		...
		StackTraits<System.Action<string,SpObject>>.Push = factory.Push_System_Action_string_SpObject;
		StackTraits<MyEventHandler>.Push = factory.Push_MyEventHandler;
	}
	...
	class UnityEngine_Events_UnityAction_object_Event : LuaDelegate
	{
		public UnityEngine_Events_UnityAction_object_Event(LuaFunction func) : base(func) { }
		public UnityEngine_Events_UnityAction_object_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public UnityEngine.Events.UnityAction<object> UnityEngine_Events_UnityAction_object(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UnityEngine.Events.UnityAction<object> fn = delegate(object param0) { };
			return fn;
		}

		if(!flag)
		{
			UnityEngine_Events_UnityAction_object_Event target = new UnityEngine_Events_UnityAction_object_Event(func);
			UnityEngine.Events.UnityAction<object> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			UnityEngine_Events_UnityAction_object_Event target = new UnityEngine_Events_UnityAction_object_Event(func, self);
			UnityEngine.Events.UnityAction<object> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_UnityEngine_Events_UnityAction_object(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(UnityEngine.Events.UnityAction<object>), L, pos);
	}

	void Push_UnityEngine_Events_UnityAction_object(IntPtr L, UnityEngine.Events.UnityAction<object> o)
	{
		ToLua.Push(L, o);
	}
	...
	class System_Predicate_bytes_Event : LuaDelegate
	{
		...
		public System_Predicate_bytes_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public System.Predicate<byte[]> System_Predicate_bytes(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
		...
		if(!flag)
		{
			System_Predicate_bytes_Event target = new System_Predicate_bytes_Event(func);
		...
		{
			System_Predicate_bytes_Event target = new System_Predicate_bytes_Event(func, self);
	...
	bool Check_System_Predicate_bytes(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Predicate<byte[]>), L, pos);
	}

	void Push_System_Predicate_bytes(IntPtr L, System.Predicate<byte[]> o)
	{
		ToLua.Push(L, o);
	}
	...
	class System_Comparison_bytes_Event : LuaDelegate
	{
		...
		public System_Comparison_bytes_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public System.Comparison<byte[]> System_Comparison_bytes(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
		...
		if(!flag)
		{
			System_Comparison_bytes_Event target = new System_Comparison_bytes_Event(func);
		...
		{
			System_Comparison_bytes_Event target = new System_Comparison_bytes_Event(func, self);
	...
	bool Check_System_Comparison_bytes(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Comparison<byte[]>), L, pos);
	}

	void Push_System_Comparison_bytes(IntPtr L, System.Comparison<byte[]> o)
	{
		ToLua.Push(L, o);
	}
	...
	public System.Action<string,SpObject> System_Action_string_SpObject(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
	...
	bool Check_System_Action_string_SpObject(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<string,SpObject>), L, pos);
	}

	void Push_System_Action_string_SpObject(IntPtr L, System.Action<string,SpObject> o)
	{
		ToLua.Push(L, o);
	}
	...
	public MyEventHandler MyEventHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
	...
	bool Check_MyEventHandler(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(MyEventHandler), L, pos);
	}

	void Push_MyEventHandler(IntPtr L, MyEventHandler o)
	{
		ToLua.Push(L, o);
	}
