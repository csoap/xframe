...
public class LuaFramework_UtilWrap
{
	...
	static int GetFunction(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaFramework.Util.GetFunction");
			}
		}
		catch (Exception e)
		{
	...
	static int ReadXMLDoc(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			System.Xml.XmlDocument arg0 = (System.Xml.XmlDocument)ToLua.CheckObject<System.Xml.XmlDocument>(L, 1);
