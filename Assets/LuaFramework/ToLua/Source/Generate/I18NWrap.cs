...
public class I18NWrap
{
	...
	static int Init(IntPtr L)
	{
		try
		{
			...
			I18N obj = (I18N)ToLua.CheckObject<I18N>(L, 1);
			obj.Init();
			return 0;
		}
		catch (Exception e)
	...
	static int getSeparateResString(IntPtr L)
	{
		try
		{
			...
			if (count == 3)
			{
				...
				string o = obj.getSeparateResString(arg0, arg1);
				LuaDLL.lua_pushstring(L, o);
				return 1;
			}
			else if (count == 4)
			{
				...
				string o = obj.getSeparateResString(arg0, arg1, arg2);
				LuaDLL.lua_pushstring(L, o);
				return 1;
			}
			else if (count == 5)
			{
				...
				string o = obj.getSeparateResString(arg0, arg1, arg2, arg3);
				LuaDLL.lua_pushstring(L, o);
				return 1;
			}
			else if (count == 6)
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: I18N.getSeparateResString");
			}
		}
		catch (Exception e)
		{
	...
	static int getResString(IntPtr L)
	{
		try
		{
			...
			if (TypeChecker.CheckTypes<I18N, int>(L, 1) && TypeChecker.CheckParamsType<object>(L, 3, count - 2))
			{
			...
			else if (TypeChecker.CheckTypes<I18N, bool[]>(L, 1) && TypeChecker.CheckParamsType<object>(L, 3, count - 2))
			{
				I18N obj = (I18N)ToLua.ToObject(L, 1);
